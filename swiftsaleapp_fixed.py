...
class SCDWhatnotGUI:
    ...
    def show_field_info(self, field_name):
            ...
            field_info = {
                ...
                "avg_sell_rate": "Calculate average time between item sales and estimated totals.",
                "start_giveaway": "Copies a giveaway announcement to clipboard. Customizable in Settings.",
                "start_flash_sale": "Copies a flash sale announcement. Customizable in Settings.",
